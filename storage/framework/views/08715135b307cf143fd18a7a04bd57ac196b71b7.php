    <head>
        <meta charset="utf-8" />
        <title>Metronic Admin Theme #4 | Support Tickets</title>
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta content="width=device-width, initial-scale=1" name="viewport" />
        <meta content="Preview page of Metronic Admin Theme #4 for main support page" name="description" />
        ...
        <link href="../admin_asset/assets/apps/css/ticket.min.css" rel="stylesheet" type="text/css" />
        <!-- END PAGE LEVEL STYLES -->
        <!-- BEGIN THEME LAYOUT STYLES -->
        <link href="../admin_asset/assets/layouts/layout4/css/layout.min.css" rel="stylesheet" type="text/css" />
        <link href="../admin_asset/assets/layouts/layout4/css/themes/default.min.css" rel="stylesheet" type="text/css" id="style_color" />
        <link href="../admin_asset/assets/layouts/layout4/css/custom.min.css" rel="stylesheet" type="text/css" />
