...
<html lang="en">
    ...
    <head>
        ...
        <link href="admin_asset/assets/global/css/components-rounded.min.css" rel="stylesheet" id="style_components" type="text/css" />
        <link href="admin_asset/assets/global/css/plugins.min.css" rel="stylesheet" type="text/css" />
        <!-- END THEME GLOBAL STYLES -->
        <!-- BEGIN PAGE LEVEL STYLES -->
        <link href="admin_asset/assets/pages/css/login-4.min.css" rel="stylesheet" type="text/css" />
        <!-- END PAGE LEVEL STYLES -->
        <!-- BEGIN THEME LAYOUT STYLES -->
        <!-- END THEME LAYOUT STYLES -->
        <link rel="shortcut icon" href="admin_asset/favicon.ico" /> </head>
    <!-- END HEAD -->

    <body class=" login" id='bd' style="background-image:url('img/bg5.jpg')">
        <!-- BEGIN LOGO -->
        <div class="logo">
            <a href="index.html">
                <img src="admin_asset/assets/pages/img/logo-big.png" alt="" /> </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
                ...
                <?php if(session('thongbao')): ?>
                    <div class="alert alert-danger" ><?php echo e(session('thongbao')); ?><br></div>
                <?php endif; ?>
        ...
        <!-- END LOGIN -->
        <!-- BEGIN COPYRIGHT -->
        <div class="copyright" style="color: red;"> DESIGN by ĐỨC THỤ & MỸ THƯƠNG </div>
        ...
        <script src="admin_asset/assets/global/plugins/backstretch/jquery.backstretch.min.js" type="text/javascript"></script>
        <!-- END PAGE LEVEL PLUGINS -->
        <!-- BEGIN THEME GLOBAL SCRIPTS -->
        <script src="admin_asset/assets/global/scripts/app.min.js" type="text/javascript"></script>
        <!-- END THEME GLOBAL SCRIPTS -->
        <!-- BEGIN PAGE LEVEL SCRIPTS -->
        <script src="admin_asset/assets/pages/scripts/login-4.min.js" type="text/javascript"></script>
