                ...
                <div class="inputs">
                     ...
                     <?php $__currentLoopData = $user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      ...
                      <div class = 'row'>
                        <div class = 'col-md-2 col-sm-2'>
                              ...
                              <?php if($value->anh != ""): ?>
                                <img src="img\profile\<?php echo e($value->anh); ?>" width="400px" class="img-responsive" alt=""> </div>
                                <?php else: ?>
                                  <img src="<?php echo e(asset('img/rong.jpg')); ?>" width="400px" class="img-responsive" alt=""> </div>
                              <?php endif; ?>
                    ...
                    <div class="btn blue btn-outline btn-circle btn-sm pull-right ct" value='<?php echo e($value->id); ?>'>chi tiết <span class="fa fa-angle-right"></span></div>
                       <div class = 'key' style = "color: black">
                         ...
                         <span style =" color: blue; font-size: 15px"><b>Tên người dùng:<?php echo e($value->name); ?></b></span> <br>
                        Tên đầy đủ: <?php echo e($value->fullname); ?> <br>      
                       email: <?php echo e($value->email); ?> <br>      
                      Cấp độ:<?php echo e($value->capdo); ?> <br>
                       Năm sinh:<?php echo e($value->namsinh); ?> <br>
                       Giới tính: <?php echo e($value->gioitinh); ?><br>
                         </div>
                         </div>
